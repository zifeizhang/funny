...
//    NSLog(@"1 = %@ 2 = %@ 3 = %@",self.shareTitle,self.shareText,self.shareUrl);
    
    if ([title isEqualToString:NSLocalizedString(@"微信好友", nil)]) {
    ...
    }else if ([title isEqualToString:NSLocalizedString(@"QQ", nil)]){
        ...
        [util shareToQQ];
    }else if ([title isEqualToString:NSLocalizedString(@"朋友圈", nil)]){
    ...
    }else if ([title isEqualToString:NSLocalizedString(@"QQ空间", nil)]){
    ...
    }else if ([title isEqualToString:NSLocalizedString(@"微博", nil)]){
...
//        NSLog(@"shareTitle ------------%@",util.shareTitle);
//        NSLog(@"shareText------------%lu",(unsigned long)util.shareText.length);
//        NSLog(@"shareUrl------------%@",util.shareUrl);
